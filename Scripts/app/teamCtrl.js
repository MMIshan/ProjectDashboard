(function () {
    ...
    app.controller('myController', ['$scope','$window','$rootScope', '$modal', '$http', '$routeParams', summaryController]);

    //angularjs controller method
    function summaryController($scope, $window, $rootScope, $modal, $http, $routeParams) {
        $scope.overall;
        ...
        function getProjectSummaries() {
            ...
            $http.get('/api/Summary/getSelectedProjectSummaries/' + $routeParams.id).success(function (data) {
        ...
        function getSelectedResults() {
            ...
            $http.get('api/Results/getSelectedResults/' + $routeParams.id + '/' + 0 + '/' + 0).success(function (data) {
                ...
                if (data.length == 0) {
                    ...
                    loadEmpAverages($routeParams.id, $scope.sendingyear, $scope.sendingmonth);
                }
        ...
        $scope.q1Click = function () {
            ...
            setTableData($routeParams.id, $scope.yearCombo,1);
        ...
        $scope.q2Click = function () {
            ...
            $scope.quarter3 = 'qnone';
            $scope.quarter4 = 'qnone';
            setTableData($routeParams.id, $scope.yearCombo, 2);
        };
        $scope.q3Click = function () {
            ...
            $scope.quarter3 = 'q1';
            $scope.quarter4 = 'qnone';
            setTableData($routeParams.id, $scope.yearCombo, 3);
        };
        $scope.q4Click = function () {
            ...
            $scope.quarter3 = 'qnone';
            $scope.quarter4 = 'q1';
            setTableData($routeParams.id, $scope.yearCombo, 4);
        };
        ...
        $scope.onClick = function (points, evt) {
            ...
            $http.get('api/Results/getSelectedResults/' + $routeParams.id + '/' + $scope.clickedYear + '/' + $scope.clickedQuarter).success(function (data) {
                $scope.selectedPro = data;
                if (data.length == 0) {
                    $scope.sh1 = false;
                } else {
                ...
                loadEmpAverages($routeParams.id, $scope.clickedYear, $scope.clickedQuarter);
