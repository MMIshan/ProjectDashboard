(function () {
    ...
    app.controller('processComplianceFormController', ['$scope','$window', '$http', '$routeParams', processComplianceFormController]);
    
    //angularjs controller method
    function processComplianceFormController($scope, $window, $http, $routeParams) {
        $scope.answerArray = [];
        function chunk(arr) {
            var newArr = [];
            var tempArray = [];
