...
angular.module('HiggidyCarousel1', [])

  .controller('HiggidyCarousel1.controller', function ($scope, $interval) {
      var timeout;
      var timeout1;
      $scope.carousel = {
          current: 0,
      ...
      $scope.setMax = function () {
          if ($scope.processComplianceDataVal) {
              $scope.carousel.max = $scope.processComplianceDataVal.length;
          } else {
  ...
  .directive('higgidyCarousel1', function () {
      var directive = {
          controller: 'HiggidyCarousel1.controller',
          scope: true,
          link: {
  ...
  .directive('higgidyCarouselImages1', function () {
      var directive = {
          scope: true,
          link: {
