(function () {
    ...
    function projectController($scope, toaster, $mdDialog, $rootScope, $http, $window, $timeout) {
        ...
        $scope.isAdmin = false;
        $scope.images = [0, 1, 2, 3, 4, 5, 6, 7, 8];
        //$scope.specShow = true;
        $scope.specHover = [["Level 0/1", "Low", 'teamlev0'], ["Level 2", "Medium", 'teamlev1'], ["Level 3", "Good", 'teamlev2'], ["Level 3", "Excellent"]];
        $scope.teamSatHover = [["0-4.4", "Low", 'teamlev0'], ["4.5-7.4", "Medium", 'teamlev1'], ["7.5-10", "Good", 'teamlev2'], ["Level 3", "Excellent"]];
        $scope.cusSatHover = [["0-2.9", "Low", 'teamlev0'], ["3-3.9", "Medium", 'teamlev1'], ["4-5", "Good", 'teamlev2'], ["Level 3", "Excellent"]];
        $scope.processComplianceHover = [["0-0.2", "Low", 'teamlev0'], ["0.3-0.4", "Medium", 'teamlev1'], [">=0.4", "Good", 'teamlev2'], ["Level 3", "Excellent"]];
        $scope.financialHover = [["0%-85%", "Low", 'teamlev0'], ["86%-95%", "Medium", 'teamlev1'], ["95%-100%", "Good", 'teamlev2'], ["Level 3", "Excellent"]];
        $scope.riskHover = [["0", "Low", 'teamlev0'], ["1-4", "Medium", 'teamlev1'], ["4-12", "Good", 'teamlev2']];
       ...
       //var myNewChart = new Chart(ct).Doughnut($scope.dougnutData, $scope.options);
        ...
        .error(function () {
            ...
            $http.get('api/Summary/getLatestProjectSummaries/' + $scope.myVal + '/' + 0 + '/' + 0).success(function (data) {
                ...
                if (angular.isObject($scope.selectedSummary)) {
                    ...
                    $scope.teamSatChartData = [$scope.teamSat, 10 - $scope.teamSat];
        ...
        function loadCustomerSatisfactionWidgetDetails() {
            ...
            $http.get('api/CustomerSatisfaction/getCustomerSatisfactionWidgetDetails/' + $scope.myVal).success(function (data) {
                ...
                if ($scope.cusSatData[2]) {
                    ...
                    $scope.customerSatData = [$scope.cusVal,10 - $scope.cusVal];
            ...
            $http.get('api/RiskManagement/getTotalRisksForSelectedAccountSubProjects/' + $scope.myVal).success(function (data) {
                ...
                if (data.length != 0) {
                    ...
                    angular.forEach(data, function (value, key) {
                        $scope.riskDataVales.push(value);
        ...
        function loadProcessComplianceWidgetDetails() {
            ...
            $http.get('api/ProcessCompliance/getProcessComplianceWidgetDetails/' + $scope.myVal).success(function (data) {
                ...
                console.log(data + " Proce  " + (angular.toJson($scope.processComData[0])!='null'));
        ...
        function loadFinancialWidgetDetails() {
            ...
            $http.get('api/FinancialSummary/getFinalMonthSummary/' + $scope.myVal + '/0/0').success(function (data) {
                ...
                if (angular.isObject(data)) {
                    ...
                    $scope.fval = data.ActualHours + "/" + data.ExpectedHours;
                    $scope.fDuration = data.Year + " - Q" + data.Quarter + " - " + data.MonthName;
                    var percentageOfBillableHours = ((data.ActualHours * 100) / data.ExpectedHours).toFixed(2);
                    ...
                    $scope.financialChartData = [percentageOfBillableHours,(100 - percentageOfBillableHours), ];
                } else {
