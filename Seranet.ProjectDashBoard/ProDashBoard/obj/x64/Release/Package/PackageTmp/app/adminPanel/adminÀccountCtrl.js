(function () {
    ...
    function adminAccountController($scope, toaster, $mdDialog, $http, $window) {
        ...
        function EditData() {
            ...
            var newAccount = { 'Id': $scope.selectedAccount, 'AccountName': $scope.accountName, 'AccCode': $scope.accountCode, 'Availability': !$scope.isAccountInactive, 'AccountOwner': $scope.accountOwner, 'Description': $scope.accountDescription };
