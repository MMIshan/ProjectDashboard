(function () {
    ...
    function adminProjectController($scope,toaster, $mdDialog,  $http, $window) {
        ...
        function loadInactiveProjects() {
            $http.get('api/Project/getInactiveProjects').success(function (data) {
        ...
        $scope.saveProject = function () {
            ...
            var project = { "Id": $scope.tempProject.Id, "AccountId": $scope.tempProject.AccountId, "Name": $scope.projectName, "ProjetCode": $scope.projectCode, "Enabled": !$scope.isProjectInactive, "ProjectOwner": $scope.productOwner, "Description": $scope.projectDescription, "Billable": $scope.isProjectBillable };
